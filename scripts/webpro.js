...
(function(a, b, c) {
    b.widget("Widget.Form", b.Widget, {
        ...
        _switchState: function(a, b) {
            ...
            b.data("error-state") && (this.errorSensitivity == "high" ? this.event != "keyup" && b.data("error-state", !1).find("input, textarea").unbind("keyup", j) : this.errorSensitivity == "medium" && this.event != "blur" && b.data("error-state", !1).find("input, textarea").unbind("blur", j));
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.0.1.310" != d.getAttribute("content") && Muse.assets.outOfDate.push("webpro.js");
                    break
                }
            }
        }
